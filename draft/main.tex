...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{draft/plots/iso_verify.pdf}
    \caption{Verification that conditional sampler is correct: draw $\chi_{\rm eff} \sim p(\chi_{\rm eff}\mid q,\mathrm{iso})$ then $p(a_1,a_2,c_1,c_2\mid\chi_{\rm eff},q,\mathrm{iso})$ which indeed results in isotropic samples as desired.}
    \label{fig:isotropic verify}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{draft/plots/x0.5q0.4.pdf}
    \caption{$\chi_{\rm eff} = 0.5$, $q=0.4$}
    \label{fig: x0.5q0.4}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{draft/plots/x0q1.pdf}
    \caption{$\chi_{\rm eff} = 0$, $q=1$}
    \label{fig: x0q1}
\end{figure}
